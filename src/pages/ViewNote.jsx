                ...
                <div className="fixed flex justify-center items-center top-0 left-0 w-full h-full bg-black/50 z-50">
                    <div className="bg-white h-1/4 lg:h-1/2 w-full lg:w-2/5 mx-16 rounded-2xl flex flex-col items-center justify-evenly px-4">
                        ...
                        <div className="flex gap-10 text-white text-2xl font-semibold">
                            <button className='bg-red-500 min-w-[9rem] px-8 py-4 rounded-lg border-[1px] border-black' onClick={closeModal}>No</button>
                            <button className='bg-blue-800 min-w-[9rem] px-8 py-4 rounded-lg border-[1px] border-black' onClick={handleDelete}>Yes</button>
                        </div>
                    </div>
                </div>
            )}
