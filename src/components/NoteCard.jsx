...
const NoteCard = ({title, description, id, date}) => {
    return (
        <NavLink to={`/view-note/${id}`} key={title} className="bg-white hover:bg-gray-100 h-80 lg:h-72 w-[calc(50%-(1.25rem/2))] lg:w-[calc(33.3333%-(1.75rem/2))] p-3 rounded-2xl box-shadow relative">
